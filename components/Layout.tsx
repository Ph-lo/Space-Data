        ...
        <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a href="https://api.spacex.land/graphql/" className="text-gray-400 hover:text-white">Graphql API</a>
              </li>
              <li>
                <a href="https://www.spacex.com" className="text-gray-400 hover:text-white">Website</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a href="http://open-notify.org/Open-Notify-API/People-In-Space/" className="text-gray-400 hover:text-white">People in space</a>
              </li>
              <li>
                <a href="http://open-notify.org/Open-Notify-API/ISS-Location-Now/" className="text-gray-400 hover:text-white">ISS positions</a>
              </li>
            </nav>
          </div>
        </div>
