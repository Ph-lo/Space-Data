...
const issPosition: NextPageWithLayout = () => {
  ...
  const fetchData = () => {
    fetch("http://api.open-notify.org/astros.json", {
      ...
      .then((r) => r.json())
      .then((res) => {
        const astronauts = res.people.filter(
          (elem: any) => elem.craft === "ISS"
        );
    ...
    <section className="sm:mt-16 xs:mt-32 text-gray-400 bg-gray-900 body-font">
      <div className="container px-5 mx-auto mb-14">
        ...
        <p className="leading-relaxed mb-5">
          The International Space Station is the largest modular space station
          currently in low Earth orbit. It is a multinational collaborative
          project involving five participating space agencies: NASA, Roscosmos,
          JAXA, ESA, and CSA.
        </p>
      </div>
      <div className="container px-5 py-5 mx-auto -mt-10 flex sm:flex-nowrap flex-wrap">
        ...
        <div className="xs:mt-590px xs:ml-0 lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <a
            ...
            className="text-white text-center bg-sky-700 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
          >
            Wikipedia
          </a>
