          ...
          <section className="text-gray-400 bg-gray-900 body-font">
            <div className="container mx-auto pl-5">
              ...
              <p className="lg:w-2/3 2xl:w-10/12 leading-relaxed text-base">
                ...
                SpaceX currently manufactures and operates the Falcon 9 Full
                Thrust family of medium-lift launch vehicles and the Falcon
                Heavy family of heavy-lift launch vehicles – both of which
                powered by SpaceX Merlin engines and employing VTVL technologies
                to reuse the first stage. As of 2020, the company is also
                developing the fully reusable Starship launch system, which will
                replace the Falcon 9 and Falcon Heavy.
              </p>
            </div>
            {loading || !data ? (
              <Loader />
              ...
              <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-wrap -m-4">
                  ...
                  <div className="p-6 flex 2xl:ml-16">
                    <a
                      href="https://en.wikipedia.org/wiki/SpaceX_launch_vehicles"
                      className="w-44 mt-auto h-14 pt-3 text-white bg-sky-700 border-0 px-8 focus:outline-none hover:bg-sky-800 rounded text-lg"
                    >
                      See the wiki
                    </a>
                  </div>
