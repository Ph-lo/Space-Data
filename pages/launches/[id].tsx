              ...
              <>
                ...
                <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
                  <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
                    {data.launch.links.video_link ? (
                      <iframe
                        className="object-cover object-center lg: w-full rounded"
                        src={toEmbed(data.launch.links.video_link)}
                      ...
                      <div className="relative w-fit">
                        <h2 className="z-10 absolute top-5 left-0 right-0 mx-auto -mr-5 font-bold text-2xl text-center">
                          No video yet !
                        </h2>
                        <Image
                          className="z-0 object-cover object-center rounded"
                          alt="hero"
                          src={shuttle}
                        />
                      </div>
                  ...
                  <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    ...
                    <Link href={`/rockets/${data.launch.rocket.rocket.id}`}>
                      <h1 className="cursor-pointer title-font sm:text-3xl text-3xl mb-4 font-medium text-white">
                    ...
                    <p className="mb-5 leading-relaxed">
                      Site : {data.launch.launch_site.site_name_long}
                    </p>
                    <p className="mb-5 leading-relaxed">
                      {data.launch.details
                        ? data.launch.details
                    ...
                    <div className="flex justify-between w-full">
                      {data.launch.links.wikipedia && (
                        <a
                          ...
                          className="inline-flex h-12 mt-3 text-white bg-sky-800 border-0 py-2 px-6 focus:outline-none hover:bg-sky-900 rounded text-lg "
                        >
                          See the wiki
                        </a>
                      )}
                ...
                {data.launch.ships.length > 0 && (
                  <div className="container mx-auto px-5">
                    <h1 className="title-font sm:text-3xl text-3xl mb-10 mt-8 font-medium text-white">
                      Ships :
                    </h1>
